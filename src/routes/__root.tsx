  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Octava — загрузчик аудио с YouTube. Ролики, плейлисты, ZIP и своя веб-морда.",
      },
    ...
    <html lang="ru" className="antialiased" suppressHydrationWarning>
      ...
      <body className="bg-bg text-fg">
        ...
        <Toaster
          ...
          toastOptions={{
            className:
              "!bg-surface !text-fg !border-0 !shadow-[0_0_0_1px_rgba(240,238,230,0.08)]",
          }}
        />
        <Scripts />
      </body>
