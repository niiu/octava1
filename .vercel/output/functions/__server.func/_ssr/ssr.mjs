...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BsAv8JC_.mjs");
...
var manifest = {
	"471041d278f466bbbcd911e755bffb17b696a719a103b0c38afabd3b26143b21": {
		...
		importer: () => import("./media.functions-GmIOoxYm.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-GyBrEjAi.mjs").then((n) => n.t),
