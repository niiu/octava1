...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C50s9Jib.mjs");
...
var manifest = {
	"471041d278f466bbbcd911e755bffb17b696a719a103b0c38afabd3b26143b21": {
		...
		importer: () => import("./media.functions-C6jFdvY4.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dsw8ZjTe.mjs").then((n) => n.t),
